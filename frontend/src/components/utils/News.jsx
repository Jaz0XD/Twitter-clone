...
const News = () => {
  return (
    <div className="border border-gray-700 rounded-[15px] mt-6 overflow-hidden">
      <p className="text-2xl font-black p-4 pl-7">
        Trending News <br></br><span className="text-sm">(Yet to be worked)</span>
      </p>
      <div>
        {/* Top news */}
        <Link
        ...
        >
          <div className="flex gap-2 items-center">
            <div className="flex flex-col w-18 lg:w-[200px]">
              ...
              <span className="w-full text-lg text-gray-500">44.5K posts</span>
            </div>
          </div>
          {/* More icon */}
